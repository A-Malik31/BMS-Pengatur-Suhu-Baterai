...
void loop() {
  ...
  temp_nano = read_temperature_from_nano(); //untuk membaca sensor dari nano
  Serial.println(temp_nano);
  send_temp_correction(myConfig.temp_setpoint);
  Serial.println(myConfig.temp_setpoint);
